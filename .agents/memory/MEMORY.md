...
- [Anime Arab APK — investigation in progress](anime-arab-apk-investigation-status.md) — RESUME HERE: need jadx/dex2jar (not installed on VPS) to properly decompile com.alarabs.alanime and find its real content API; first pass only found ad-SDK strings.
