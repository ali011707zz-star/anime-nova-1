...
android {
    ...
    defaultConfig {
    applicationId = "com.nova.anime.tv.v2"
        minSdk = 24
        targetSdk = 35
        versionCode = 200
        versionName = "2.0.0"
        ...
        buildConfigField("String", "NOVA_CLIENT_ID", "\"nova-anime-tv-kotlin-v2\"")
        buildConfigField("String", "NOVA_VERSION", "\"2.0.0\"")
        buildConfigField("String", "NOVA_PACKAGE", "\"com.nova.anime.tv.v2\"")
    }
