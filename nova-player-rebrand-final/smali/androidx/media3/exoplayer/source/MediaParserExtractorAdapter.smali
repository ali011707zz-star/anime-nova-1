...
.method private constructor <init>(Landroidx/media3/exoplayer/analytics/PlayerId;Ljava/util/Map;)V
    ...
    invoke-static {v0, v1}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/MediaParser$OutputConsumer;[Ljava/lang/String;)Landroid/media/MediaParser;
    ...
    invoke-static {v0, v2, v1}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
    ...
    invoke-static {v1, v2, v0}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/MediaParser;Ljava/lang/String;Ljava/lang/Object;)Landroid/media/MediaParser;
...
.method public init(Landroidx/media3/common/DataReader;Landroid/net/Uri;Ljava/util/Map;JJLandroidx/media3/extractor/ExtractorOutput;)V
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/MediaParser;)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z
...
.method public read(Landroidx/media3/extractor/PositionHolder;)I
    ...
    invoke-static {v0, v1}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekableInputReader;)Z
...
.method public release()V
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/source/MediaParserExtractorAdapter$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/MediaParser;)V
...
.method public seek(JJ)V
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/source/MediaParserExtractorAdapter$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/media/MediaParser$SeekPoint;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/exoplayer/source/MediaParserExtractorAdapter$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/MediaParser$SeekPoint;)J
    ...
    :goto_0
    invoke-static {p1}, Landroidx/media3/exoplayer/source/MediaParserExtractorAdapter$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/media/MediaParser$SeekPoint;
    ...
    :goto_1
    invoke-static {p4, p1}, Landroidx/media3/exoplayer/hls/MediaParserHlsMediaChunkExtractor$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/MediaParser;Landroid/media/MediaParser$SeekPoint;)V
