...
# direct methods
.method public static synthetic $r8$lambda$7Kmj349OLYgoSoS_sBzpedENrIo(Landroid/media/AudioTrack;Landroid/os/Handler;Landroidx/media3/common/util/ListenerSet;)V
    .locals 2
    ...
    .line 468
    new-instance p0, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda7;

    invoke-direct {p0, p2}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda7;-><init>(Landroidx/media3/common/util/ListenerSet;)V
    ...
    .line 468
    new-instance v1, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda7;

    invoke-direct {v1, p2}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda7;-><init>(Landroidx/media3/common/util/ListenerSet;)V
...
.method public static synthetic $r8$lambda$JTyOMQgTVjn2JuPrAI8Rp4gKPbU(Landroidx/media3/common/util/ListenerSet;)V
    .locals 1

    .line 468
    new-instance v0, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda6;

    invoke-direct {v0}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda6;-><init>()V
...
.method private getAudioOutputUnderrunCount(J)I
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioTrack;)I
    ...
    .line 443
    iget p1, p0, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput;->lastUnderrunCount:I
...
.method private maybeReportUnderrun()V
    ...
    new-instance v1, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda5;

    invoke-direct {v1}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda5;-><init>()V
...
.method private static releaseAudioTrackAsync(Landroid/media/AudioTrack;Landroidx/media3/common/util/ListenerSet;)V
    ...
    new-instance v3, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda8;

    invoke-direct {v3, p0, v0, p1}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticLambda8;-><init>(Landroid/media/AudioTrack;Landroid/os/Handler;Landroidx/media3/common/util/ListenerSet;)V
...
.method public release()V
    ...
    check-cast v1, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$StreamEventCallbackV29;
...
.method public setOffloadDelayPadding(II)V
    ...
    invoke-static {v0, p1, p2}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioTrack;II)V
...
.method public setOffloadEndOfStream()V
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/audio/AudioTrackAudioOutput$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack;)V
