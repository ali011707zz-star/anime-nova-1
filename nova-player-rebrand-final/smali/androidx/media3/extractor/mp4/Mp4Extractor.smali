...
.method public static synthetic $r8$lambda$Jqdfn1GZSw0gjR45qmA4488uqfI(Landroidx/media3/container/MdtaMetadataEntry;)Z
    .locals 1
...
.method public static synthetic $r8$lambda$uxB_7KVYtROj14NCkbsXBOZtwRw(Landroidx/media3/container/MdtaMetadataEntry;)Z
    .locals 1
...
.method public static synthetic $r8$lambda$xLjHse2QhjdCXSXD24V8tl0dStk(Landroidx/media3/container/MdtaMetadataEntry;)Z
    .locals 1
...
.method private getAuxiliaryTrackTypesForAuxiliaryTracks(Landroidx/media3/common/Metadata;)Ljava/util/List;
    ...
    .line 818
    new-instance v0, Landroidx/media3/extractor/mp4/Mp4Extractor$$ExternalSyntheticLambda5;

    invoke-direct {v0}, Landroidx/media3/extractor/mp4/Mp4Extractor$$ExternalSyntheticLambda5;-><init>()V

    .line 820
    const-class v1, Landroidx/media3/container/MdtaMetadataEntry;

    invoke-virtual {p1, v1, v0}, Landroidx/media3/common/Metadata;->getFirstMatchingEntry(Ljava/lang/Class;Lcom/google/common/base/Predicate;)Landroidx/media3/common/Metadata$Entry;
...
.method private processMoovAtom(Landroidx/media3/container/Mp4Box$ContainerBox;)V
    ...
    .line 667
    iget v10, v15, Landroidx/media3/extractor/mp4/TrackSampleTable;->sampleCount:I
    ...
    .line 670
    :cond_8
    iget-object v10, v15, Landroidx/media3/extractor/mp4/TrackSampleTable;->track:Landroidx/media3/extractor/mp4/Track;

    .line 671
    new-instance v7, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;
    ...
    .line 672
    invoke-interface {v4, v9, v1}, Landroidx/media3/extractor/ExtractorOutput;->track(II)Landroidx/media3/extractor/TrackOutput;

    move-result-object v1

    invoke-direct {v7, v10, v15, v1}, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;-><init>(Landroidx/media3/extractor/mp4/Track;Landroidx/media3/extractor/mp4/TrackSampleTable;Landroidx/media3/extractor/TrackOutput;)V
    ...
    :cond_9
    iget-wide v3, v15, Landroidx/media3/extractor/mp4/TrackSampleTable;->durationUs:J

    .line 675
    :goto_6
    iget-object v9, v7, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;->trackOutput:Landroidx/media3/extractor/TrackOutput;

    invoke-interface {v9, v3, v4}, Landroidx/media3/extractor/TrackOutput;->durationUs(J)V
    ...
    .line 696
    :cond_c
    iget-boolean v5, v0, Landroidx/media3/extractor/mp4/Mp4Extractor;->readingAuxiliaryTracks:Z
    ...
    invoke-virtual {v9, v5}, Landroidx/media3/common/Format$Builder;->setAuxiliaryTrackType(I)Landroidx/media3/common/Format$Builder;

    .line 700
    :cond_d
    invoke-virtual {v9, v1}, Landroidx/media3/common/Format$Builder;->setRoleFlags(I)Landroidx/media3/common/Format$Builder;

    .line 705
    :cond_e
    invoke-static {v15, v3, v4}, Landroidx/media3/extractor/mp4/Mp4Extractor;->findBestThumbnailPresentationTimeUs(Landroidx/media3/extractor/mp4/TrackSampleTable;J)J
    ...
    invoke-static {v3, v2, v9}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatGaplessInfo(ILandroidx/media3/extractor/GaplessInfoHolder;Landroidx/media3/common/Format$Builder;)V
    ...
    invoke-direct {v5, v6}, Landroidx/media3/common/Metadata;-><init>(Ljava/util/List;)V
    ...
    .line 711
    invoke-static {v3, v12, v9, v4, v6}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatMetadata(ILandroidx/media3/common/Metadata;Landroidx/media3/common/Format$Builder;Landroidx/media3/common/Metadata;[Landroidx/media3/common/Metadata;)V

    move-object/from16 v1, v25

    .line 720
    invoke-virtual {v9, v1}, Landroidx/media3/common/Format$Builder;->setContainerMimeType(Ljava/lang/String;)Landroidx/media3/common/Format$Builder;
    ...
    iput-object v3, v7, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;->pendingFormat:Landroidx/media3/common/Format;

    goto :goto_b

    .line 730
    :cond_11
    iget-object v3, v7, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;->trackOutput:Landroidx/media3/extractor/TrackOutput;
    ...
    .line 738
    new-array v1, v7, [Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;
    ...
    invoke-direct {v2, v5, v6, v3, v11}, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4SeekMap;-><init>(J[Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;I)V
...
.method private shouldSeekToAxteAtom(Landroidx/media3/common/Metadata;)Z
    ...
    .line 785
    :cond_0
    new-instance v1, Landroidx/media3/extractor/mp4/Mp4Extractor$$ExternalSyntheticLambda3;

    invoke-direct {v1}, Landroidx/media3/extractor/mp4/Mp4Extractor$$ExternalSyntheticLambda3;-><init>()V

    .line 786
    const-class v2, Landroidx/media3/container/MdtaMetadataEntry;

    invoke-virtual {p1, v2, v1}, Landroidx/media3/common/Metadata;->getFirstMatchingEntry(Ljava/lang/Class;Lcom/google/common/base/Predicate;)Landroidx/media3/common/Metadata$Entry;
