...
class MainActivity : ComponentActivity() {
    ...
    private fun buildUi() {
        ...
        val content = LinearLayout(this).apply {
            ...
            setPadding(dp(54), dp(34), dp(54), dp(70))
        ...
        val brand = tvText(this, "NOVA TV", 31f).apply {
            setTextColor(Color.rgb(216, 180, 254))
            typeface = android.graphics.Typeface.DEFAULT_BOLD
        }
        header.addView(brand, LinearLayout.LayoutParams(0, dp(62), 1f))
        ...
        header.addView(search, LinearLayout.LayoutParams(dp(150), dp(62)))
        content.addView(header)

        val subtitle = tvText(this, "منصة الأنمي العربية للتلفاز", 17f, Color.rgb(161, 161, 170))
        ...
        content.addView(progress, LinearLayout.LayoutParams(dp(46), dp(46)).apply {
    ...
    private fun addRow(label: String, items: List<AnimeItem>) {
        ...
        rowsContainer.addView(title, LinearLayout.LayoutParams(-1, dp(64)))
        ...
        val list = RecyclerView(this).apply {
            ...
            clipChildren = false
            setPadding(dp(8), dp(12), dp(8), dp(16))
            clipToPadding = false
            layoutDirection = View.LAYOUT_DIRECTION_LTR
        }
        rowsContainer.addView(list, LinearLayout.LayoutParams(-1, dp(315)))
    }
