...
object ApiClient {
    private const val CLIENT_ID = "nova-anime-tv-kotlin-v1"
    private const val VERSION = "1.0.0"
    private const val PACKAGE_NAME = "com.nova.anime.tv"
    private const val USER_AGENT = "NovaTV/1.0.0 (Android TV)"
        ...
        response.use {
            ...
            if (it.code == 403 && retryOnToken) {
                ...
                if (code == "INVALID_TOKEN") {
                    ...
                    return@withContext request(httpRequest.newBuilder().build(), retryOnToken = false)
                }
            }
    ...
    private suspend fun coroutineSafeHome(): HomeRows {
        val queries = listOf(
            "latest" to """
