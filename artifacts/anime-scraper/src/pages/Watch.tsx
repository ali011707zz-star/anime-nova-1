...
const SCRAPER_DEFS: { site: string; name: string; desc: string; tag: string; audioLang?: "en"; isArabic?: true }[] = [
  ...
  { site: "consumet_saturn",  name: "AnimeSaturn",  desc: "HLS/MP4 · صوت خام", tag: "SAT" },
  { site: "consumet_anikoto", name: "AniKoto",      desc: "HLS/MP4 · صوت خام", tag: "KOTO" },
...
const STATIC_PICKER_WEB: Record<WebQualityKey, { site: string; tag: string }[]> = {
  "1080p": [
    ...
    { site: "consumet_saturn", tag: "SAT" },
    { site: "consumet_anikoto", tag: "KOTO" },
  ],
  "720p": [
    { site: "anineko",      tag: "AN" },
    { site: "animewitcher", tag: "AW" },
