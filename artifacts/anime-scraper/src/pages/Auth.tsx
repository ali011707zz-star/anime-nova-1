...
function GoogleBtn() {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl font-bold font-['Cairo'] text-[13px] transition-all active:scale-[0.98] disabled:opacity-60"
      style={{
    ...
    >
      ...
      {loading ? "جاري الاتصال..." : "تسجيل الدخول بـ Google"}
    </button>
  );
}
