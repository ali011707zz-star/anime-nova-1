        ...
        <div className="mt-5">
          ...
          <div className="flex gap-3 overflow-x-auto px-4 pb-2" style={{ scrollbarWidth: "none" }}>
            {todayEps.map((it: any, i: number) => {
              ...
              const href = `/watch?anime=0&ep=${it.episode}&title=${encodeURIComponent(it.name || "")}&english=${encodeURIComponent(it.name || "")}&cover=${encodeURIComponent(it.cover || "")}&site=anslayer&anslayerId=${it.animeId}&single=1`;
              return (
