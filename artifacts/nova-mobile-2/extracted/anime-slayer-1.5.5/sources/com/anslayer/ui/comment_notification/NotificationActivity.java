package com.anslayer.ui.comment_notification;
...
public final class NotificationActivity extends a<z> {
    ...
    public void onCreate(Bundle bundle) {
        ...
        c().f8864c.setNavigationOnClickListener(new View.OnClickListener() { // from class: v5.a
        ...
        if (bundle == null) {
            ...
            m10.u(true);
            l.e(m10.d(R.id.fragment_container_view, i.class, getIntent().getExtras(), null), "add(containerViewId, F::class.java, args, tag)");
            m10.i();
        }
    }
}
