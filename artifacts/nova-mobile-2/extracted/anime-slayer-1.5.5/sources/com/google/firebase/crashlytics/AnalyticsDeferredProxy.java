...
public class AnalyticsDeferredProxy {
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new Deferred.DeferredHandler() { // from class: z9.c
    ...
    public /* synthetic */ void lambda$init$2(Provider provider) {
        ...
        if (subscribeToAnalyticsEvents(analyticsConnector, crashlyticsAnalyticsListener) != null) {
            ...
            synchronized (this) {
                Iterator<BreadcrumbHandler> it2 = this.breadcrumbHandlerList.iterator();
                while (it2.hasNext()) {
    ...
    public AnalyticsEventLogger getAnalyticsEventLogger() {
        return new AnalyticsEventLogger() { // from class: z9.a
    ...
    public BreadcrumbSource getDeferredBreadcrumbSource() {
        return new BreadcrumbSource() { // from class: z9.b
