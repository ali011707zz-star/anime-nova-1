...
public class r {
    ...
    public static final int[] f1478c = {R.attr.indeterminateDrawable, R.attr.progressDrawable};

    /* renamed from: a, reason: collision with root package name */
    public final ProgressBar f1479a;

    /* renamed from: b, reason: collision with root package name */
    public Bitmap f1480b;
    ...
    public void c(AttributeSet attributeSet, int i10) {
        v0 v10 = v0.v(this.f1479a.getContext(), attributeSet, f1478c, i10, 0);
        Drawable h10 = v10.h(0);
        if (h10 != null) {
            this.f1479a.setIndeterminateDrawable(e(h10));
        }
        Drawable h11 = v10.h(1);
        if (h11 != null) {
            this.f1479a.setProgressDrawable(d(h11, false));
        }
        v10.w();
    }
