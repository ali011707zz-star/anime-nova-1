...
public final class HttpUrl {
    ...
    public static String canonicalize(String str, int i10, int i11, String str2, boolean z10, boolean z11, boolean z12, boolean z13, Charset charset) {
        ...
        while (i12 < i11) {
            ...
            f fVar = new f();
            fVar.m(str, i10, i12);
            canonicalize(fVar, str, i12, i11, str2, z10, z11, z12, z13, charset);
            return fVar.J0();
        }
    ...
    public static String percentDecode(String str, int i10, int i11, boolean z10) {
        for (int i12 = i10; i12 < i11; i12++) {
            ...
            if (charAt == '%' || (charAt == '+' && z10)) {
                f fVar = new f();
                fVar.m(str, i10, i12);
                percentDecode(fVar, str, i12, i11, z10);
                return fVar.J0();
            }
        }
        return str.substring(i10, i11);
    ...
    public static void canonicalize(f fVar, String str, int i10, int i11, String str2, boolean z10, boolean z11, boolean z12, boolean z13, Charset charset) {
        f fVar2 = null;
        while (i10 < i11) {
            int codePointAt = str.codePointAt(i10);
            if (!z10 || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                if (codePointAt == 43 && z12) {
                    fVar.t0(z10 ? BadgeDrawable.DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX : "%2B");
                    ...
                    if (charset != null && !charset.equals(Util.UTF_8)) {
                        fVar2.a1(str, i10, Character.charCount(codePointAt) + i10, charset);
                    } else {
    ...
    public static void percentDecode(f fVar, String str, int i10, int i11, boolean z10) {
        int i12;
        while (i10 < i11) {
            int codePointAt = str.codePointAt(i10);
            if (codePointAt == 37 && (i12 = i10 + 2) < i11) {
                ...
                if (decodeHexDigit != -1 && decodeHexDigit2 != -1) {
                    fVar.O((decodeHexDigit << 4) + decodeHexDigit2);
                    i10 = i12;
                }
                fVar.e1(codePointAt);
            } else {
