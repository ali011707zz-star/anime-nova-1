...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectSocket(int i10, int i11, Call call, EventListener eventListener) throws IOException {
        ...
        try {
            ...
            try {
                this.source = p.d(p.m(this.rawSocket));
    ...
    private Request createTunnel(int i10, int i11, Request request, HttpUrl httpUrl) throws IOException {
        ...
        while (true) {
            ...
            c0 newFixedLengthSource = http1Codec.newFixedLengthSource(contentLength);
            Util.skipAll(newFixedLengthSource, Api.BaseClientBuilder.API_PRIORITY_OTHER, timeUnit);
            newFixedLengthSource.close();
            int code = build.code();
            if (code == 200) {
                if (this.source.c().M() && this.sink.c().M()) {
                    return null;
                }
    ...
    */
    public void connect(int i10, int i11, int i12, int i13, boolean z10, Call call, EventListener eventListener) {
    ...
    public HttpCodec newCodec(OkHttpClient okHttpClient, Interceptor.Chain chain, StreamAllocation streamAllocation) throws SocketException {
        ...
        d0 timeout = this.source.timeout();
