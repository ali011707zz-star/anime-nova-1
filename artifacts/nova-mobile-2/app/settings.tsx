    ...
    <View style={{ flex: 1, backgroundColor: "#09090B" }}>
      ...
      <View style={[ts.header, { paddingTop: topPad }]}>
        <View style={ts.headerBadge}>
          ...
          <Text style={ts.headerBadgeText}>NOVA MOBILE 2 · v2.0</Text>
        </View>
          ...
          <Card>
            ...
            <View style={ts.navRow}>
              ...
              <View style={[ts.navText, { alignItems: "flex-end" }]}>
                ...
                <Text style={ts.navSub}>NOVA MOBILE 2 · تطبيق بث الأنمي العربي</Text>
              </View>
              <Text style={{ fontSize: 12, fontFamily: "Cairo_700Bold", color: "#a78bfa" }}>v2.0.0</Text>
            </View>
            {/* Privacy */}
            <View style={ts.navRow}>
