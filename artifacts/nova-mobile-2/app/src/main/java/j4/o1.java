...
public final class o1 implements a2.a {
    ...
    public final FragmentContainerView f8600b;

    public o1(LinearLayout linearLayout, FragmentContainerView fragmentContainerView) {
        this.f8599a = linearLayout;
        this.f8600b = fragmentContainerView;
    }

    public static o1 a(View view) {
        FragmentContainerView fragmentContainerView = (FragmentContainerView) a2.b.a(view, R.id.fragment_container_view);
        if (fragmentContainerView != null) {
            return new o1((LinearLayout) view, fragmentContainerView);
        }
