...
public class ScribeConfig {
    ...
    public ScribeConfig(boolean z10, String str, String str2, String str3, String str4, String str5, int i10, int i11) {
        this.isEnabled = z10;
        this.baseUrl = str;
        ...
        this.sequence = str4;
        this.userAgent = str5;
        this.maxFilesToKeep = i10;
        this.sendIntervalSeconds = i11;
    }
}
