...
class SSOAuthHandler extends AuthHandler {
    ...
    public SSOAuthHandler(TwitterAuthConfig twitterAuthConfig, Callback<TwitterSession> callback, int i10) {
    ...
    private boolean startAuthActivityForResult(Activity activity) {
        ...
        try {
            ...
            Twitter.getLogger().e("Twitter", "SSO exception occurred", e10);
            return false;
        }
    }
