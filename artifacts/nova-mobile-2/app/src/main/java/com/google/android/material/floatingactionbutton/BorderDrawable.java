...
public class BorderDrawable extends Drawable {
    ...
    private Shader createGradientShader() {
        ...
        return new LinearGradient(StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, r0.top, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, r0.bottom, new int[]{d.f(this.topOuterStrokeColor, this.currentBorderTintColor), d.f(this.topInnerStrokeColor, this.currentBorderTintColor), d.f(d.j(this.topInnerStrokeColor, 0), this.currentBorderTintColor), d.f(d.j(this.bottomInnerStrokeColor, 0), this.currentBorderTintColor), d.f(this.bottomInnerStrokeColor, this.currentBorderTintColor), d.f(this.bottomOuterStrokeColor, this.currentBorderTintColor)}, new float[]{StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, height, 0.5f, 0.5f, 1.0f - height, 1.0f}, Shader.TileMode.CLAMP);
    }
    ...
    public int getOpacity() {
        return this.borderWidth > StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD ? -3 : -2;
    }
