...
public final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private static final int[] DURATION_TO_MOVE_SEGMENT_ENDS = {533, 567, 850, AnimationDuration.LONG};
    ...
    private void updateSegmentPositions(int i10) {
        for (int i11 = 0; i11 < 4; i11++) {
            this.segmentPositions[i11] = Math.max(StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, Math.min(1.0f, this.interpolatorArray[i11].getInterpolation(getFractionInRange(i10, DELAY_TO_MOVE_SEGMENT_ENDS[i11], DURATION_TO_MOVE_SEGMENT_ENDS[i11]))));
        }
    }
