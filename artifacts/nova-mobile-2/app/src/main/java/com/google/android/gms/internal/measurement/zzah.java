...
public final class zzah implements zzap {
    ...
    public final Boolean zzg() {
        boolean z10 = false;
        if (!Double.isNaN(this.zza.doubleValue()) && this.zza.doubleValue() != ShadowDrawableWrapper.COS_45) {
            z10 = true;
        }
    ...
    public final String zzi() {
        ...
        if (Double.isInfinite(this.zza.doubleValue())) {
            return this.zza.doubleValue() > ShadowDrawableWrapper.COS_45 ? "Infinity" : "-Infinity";
        }
