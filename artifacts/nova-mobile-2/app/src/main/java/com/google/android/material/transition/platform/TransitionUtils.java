...
class TransitionUtils {
    ...
    public static boolean maybeApplyThemeDuration(Transition transition, Context context, int i10) {
        int resolveInteger;
        if (i10 == 0 || transition.getDuration() != -1 || (resolveInteger = MaterialAttributes.resolveInteger(context, i10, -1)) == -1) {
            return false;
        }
    ...
    public static boolean maybeApplyThemeInterpolator(Transition transition, Context context, int i10, TimeInterpolator timeInterpolator) {
    ...
    public static boolean maybeApplyThemePath(Transition transition, Context context, int i10) {
    ...
    public static TimeInterpolator resolveThemeInterpolator(Context context, int i10, TimeInterpolator timeInterpolator) {
        ...
        if (typedValue.type == 3) {
            ...
            if (isEasingType(valueOf, "path")) {
                return b.b(g.e(getEasingContent(valueOf, "path")));
            }
    ...
    public static PathMotion resolveThemePath(Context context, int i10) {
        TypedValue typedValue = new TypedValue();
        if (!context.getTheme().resolveAttribute(i10, typedValue, true)) {
            return null;
        }
        ...
        if (i11 != 16) {
            if (i11 == 3) {
                return new PatternPathMotion(g.e(String.valueOf(typedValue.string)));
            }
