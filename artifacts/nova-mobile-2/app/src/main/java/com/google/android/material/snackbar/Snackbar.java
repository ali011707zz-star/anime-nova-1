...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
        ...
        public void onMeasure(int i10, int i11) {
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt.getLayoutParams().width == -1) {
                    childAt.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth, NTLMEngineImpl.FLAG_NEGOTIATE_KEY_EXCH), View.MeasureSpec.makeMeasureSpec(childAt.getMeasuredHeight(), NTLMEngineImpl.FLAG_NEGOTIATE_KEY_EXCH));
                }
            }
        }
    ...
    private static Snackbar makeInternal(Context context, View view, CharSequence charSequence, int i10) {
    ...
    public Snackbar setMaxInlineActionWidth(int i10) {
    ...
    public static Snackbar make(Context context, View view, CharSequence charSequence, int i10) {
