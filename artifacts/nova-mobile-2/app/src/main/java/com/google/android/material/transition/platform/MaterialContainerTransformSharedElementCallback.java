...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    public static void removeWindowBackground(Window window) {
        window.getDecorView().getBackground().mutate().setColorFilter(a.a(0, b.CLEAR));
    }
    ...
    public void onSharedElementStart(List<String> list, List<View> list2, List<View> list3) {
        ...
        View view = list2.get(0);
        view.measure(View.MeasureSpec.makeMeasureSpec(this.returnEndBounds.width(), NTLMEngineImpl.FLAG_NEGOTIATE_KEY_EXCH), View.MeasureSpec.makeMeasureSpec(this.returnEndBounds.height(), NTLMEngineImpl.FLAG_NEGOTIATE_KEY_EXCH));
