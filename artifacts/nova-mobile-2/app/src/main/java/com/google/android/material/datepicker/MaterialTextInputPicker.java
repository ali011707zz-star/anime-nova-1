...
public final class MaterialTextInputPicker<S> extends PickerFragment<S> {
    ...
    public static <T> MaterialTextInputPicker<T> newInstance(DateSelector<T> dateSelector, int i10, CalendarConstraints calendarConstraints) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        return this.dateSelector.onCreateTextInputView(layoutInflater.cloneInContext(new ContextThemeWrapper(getContext(), this.themeResId)), viewGroup, bundle, this.calendarConstraints, new OnSelectionChangedListener<S>() { // from class: com.google.android.material.datepicker.MaterialTextInputPicker.1
            ...
            public void onSelectionChanged(S s10) {
                Iterator<OnSelectionChangedListener<S>> it2 = MaterialTextInputPicker.this.onSelectionChangedListeners.iterator();
                while (it2.hasNext()) {
                    it2.next().onSelectionChanged(s10);
                }
            }
        });
    }
