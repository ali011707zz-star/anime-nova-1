...
public class CircularRevealHelper {
    ...
    private float getDistanceToFurthestCorner(CircularRevealWidget.RevealInfo revealInfo) {
        return MathUtils.distanceToFurthestCorner(revealInfo.centerX, revealInfo.centerY, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, this.view.getWidth(), this.view.getHeight());
    }
    ...
    public void draw(Canvas canvas) {
        if (shouldDrawCircularReveal()) {
            ...
            if (i10 == 0) {
                ...
                this.delegate.actualDraw(canvas);
                if (shouldDrawScrim()) {
                    canvas.drawRect(StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, this.view.getWidth(), this.view.getHeight(), this.scrimPaint);
                }
