...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static class SnackbarBaseLayout extends FrameLayout {
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            if (drawable != null && this.backgroundTint != null) {
                ...
                a.o(drawable, this.backgroundTint);
                a.p(drawable, this.backgroundTintMode);
            }
        ...
        public void setBackgroundTintList(ColorStateList colorStateList) {
            ...
            if (getBackground() != null) {
                ...
                a.p(r10, this.backgroundTintMode);
        ...
        public SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(R.styleable.SnackbarLayout_elevation)) {
                b0.B0(this, obtainStyledAttributes.getDimensionPixelSize(r1, 0));
            }
            ...
            setFocusable(true);
            if (getBackground() == null) {
                b0.x0(this, createThemedBackground());
            }
        }
    }
    ...
    public void startFadeInAnimation() {
        ValueAnimator alphaAnimator = getAlphaAnimator(StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, 1.0f);
    ...
    private void startFadeOutAnimation(final int i10) {
        ValueAnimator alphaAnimator = getAlphaAnimator(1.0f, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD);
    ...
    public void startSlideInAnimation() {
        ...
        if (USE_OFFSET_API) {
            b0.e0(this.view, translationYBottom);
        } else {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.16
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    b0.e0(BaseTransientBottomBar.this.view, intValue - this.previousAnimatedIntValue);
                } else {
    ...
    public BaseTransientBottomBar(Context context, ViewGroup viewGroup, View view, com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        if (contentViewCallback != null) {
            ...
            b0.v0(snackbarBaseLayout, 1);
            b0.E0(snackbarBaseLayout, 1);
            b0.C0(snackbarBaseLayout, true);
            b0.G0(snackbarBaseLayout, new u() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.4
                @Override // q0.u
                public m0 onApplyWindowInsets(View view2, m0 m0Var) {
                    BaseTransientBottomBar.this.extraBottomMarginWindowInset = m0Var.i();
                    BaseTransientBottomBar.this.extraLeftMarginWindowInset = m0Var.j();
                    BaseTransientBottomBar.this.extraRightMarginWindowInset = m0Var.k();
                    BaseTransientBottomBar.this.updateMargins();
                    return m0Var;
                }
            });
            b0.t0(snackbarBaseLayout, new q0.a() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.5
                @Override // q0.a
