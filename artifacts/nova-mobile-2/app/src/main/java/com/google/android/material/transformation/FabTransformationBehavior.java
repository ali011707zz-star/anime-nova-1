...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f10, float f11, boolean z10, FabTransformationSpec fabTransformationSpec) {
        ...
        } else if ((z10 && f11 < StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD) || (!z10 && f11 > StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD)) {
    ...
    private float calculateRevealCenterX(View view, View view2, Positioning positioning) {
        ...
        rectF2.offset(-calculateTranslationX(view, view2, positioning), StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD);
    ...
    private float calculateRevealCenterY(View view, View view2, Positioning positioning) {
        ...
        calculateDependencyWindowBounds(view, rectF);
        calculateWindowBounds(view2, rectF2);
        rectF2.offset(StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, -calculateTranslationY(view, view2, positioning));
    ...
    private void createChildrenFadeAnimation(View view, View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof ViewGroup) {
            ...
            if (z10) {
                if (!z11) {
                    ChildrenAlphaProperty.CHILDREN_ALPHA.set(calculateChildContentContainer, Float.valueOf(StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD));
                }
                ofFloat = ObjectAnimator.ofFloat(calculateChildContentContainer, ChildrenAlphaProperty.CHILDREN_ALPHA, 1.0f);
            } else {
                ofFloat = ObjectAnimator.ofFloat(calculateChildContentContainer, ChildrenAlphaProperty.CHILDREN_ALPHA, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD);
            }
    ...
    private void createElevationAnimation(View view, View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator ofFloat;
        float y10 = b0.y(view2) - b0.y(view);
        if (z10) {
            if (!z11) {
                view2.setTranslationZ(-y10);
            }
            ofFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD);
        } else {
            ofFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Z, -y10);
        }
    ...
    private void createExpansionAnimation(View view, View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, float f10, float f11, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z10) {
                ...
                animator = CircularRevealCompat.createCircularReveal(circularRevealWidget, calculateRevealCenterX, calculateRevealCenterY, MathUtils.distanceToFurthestCorner(calculateRevealCenterX, calculateRevealCenterY, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, f10, f11));
    ...
    private void createIconFadeAnimation(View view, final View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if ((view2 instanceof CircularRevealWidget) && (view instanceof ImageView)) {
            ...
            if (z10) {
                ...
                ofInt = ObjectAnimator.ofInt(drawable, DrawableAlphaProperty.DRAWABLE_ALPHA_COMPAT, BaseProgressIndicator.MAX_ALPHA);
            }
    ...
    private void createTranslationAnimation(View view, View view2, boolean z10, boolean z11, FabTransformationSpec fabTransformationSpec, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        if (z10) {
            ...
            ofFloat = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_X, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD);
            ofFloat2 = ObjectAnimator.ofFloat(view2, (Property<View, Float>) View.TRANSLATION_Y, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD);
            calculateChildVisibleBoundsAtEndOfExpansion(view2, fabTransformationSpec, motionTiming, motionTiming2, -calculateTranslationX, -calculateTranslationY, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD, rectF);
        } else {
