...
public class AppSettingsData {
    ...
    public AppSettingsData(String str, String str2, String str3, String str4, String str5, String str6, boolean z10, int i10, int i11) {
        this.status = str;
        this.url = str2;
        ...
        this.reportUploadVariant = i10;
        this.nativeReportUploadVariant = i11;
    }

    public AppSettingsData(String str, String str2, String str3, String str4, boolean z10) {
