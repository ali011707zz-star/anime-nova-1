...
public class MaterialToolbar extends Toolbar {
    ...
    private void layoutTitleCenteredHorizontally(View view, Pair<Integer, Integer> pair) {
        ...
        if (max > 0) {
            i10 += max;
            i11 -= max;
            view.measure(View.MeasureSpec.makeMeasureSpec(i11 - i10, NTLMEngineImpl.FLAG_NEGOTIATE_KEY_EXCH), view.getMeasuredHeightAndState());
        }
    ...
    private Drawable maybeTintNavigationIcon(Drawable drawable) {
        ...
        a.n(r10, this.navigationIconTint.intValue());
        return r10;
    }
