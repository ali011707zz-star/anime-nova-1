...
public class MaterialDialogs {
    ...
    public static Rect getDialogBackgroundInsets(Context context, int i10, int i11) {
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, null, R.styleable.MaterialAlertDialog, i10, i11, new int[0]);
