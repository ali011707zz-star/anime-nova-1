...
public final class zaaa {
    ...
    public final void zaa(BasePendingResult<? extends Result> basePendingResult, boolean z10) {
        this.zaa.put(basePendingResult, Boolean.valueOf(z10));
        basePendingResult.addStatusListener(new zay(this, basePendingResult));
    }

    public final <TResult> void zab(TaskCompletionSource<TResult> taskCompletionSource, boolean z10) {
