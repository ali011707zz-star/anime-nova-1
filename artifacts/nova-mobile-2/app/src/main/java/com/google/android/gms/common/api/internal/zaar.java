...
public final class zaar implements zaba {
    ...
    private final void zaB() {
        ...
        Iterator<Api.AnyClientKey<?>> it2 = this.zaa.zab.keySet().iterator();
        while (it2.hasNext()) {
            ((Api.Client) Preconditions.checkNotNull(this.zaa.zaa.get(it2.next()))).disconnect();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @GuardedBy("mLock")
    public final void zaC(ConnectionResult connectionResult, Api<?> api, boolean z10) {
    ...
    @GuardedBy("mLock")
    private final void zaG(boolean z10) {
        com.google.android.gms.signin.zae zaeVar = this.zak;
        if (zaeVar != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    @GuardedBy("mLock")
    public final boolean zaI(int i10) {
        if (this.zag == i10) {
            return true;
        }
        this.zaa.zag.zae();
        ...
        String zaJ2 = zaJ(i10);
        StringBuilder sb4 = new StringBuilder(zaJ.length() + 70 + zaJ2.length());
