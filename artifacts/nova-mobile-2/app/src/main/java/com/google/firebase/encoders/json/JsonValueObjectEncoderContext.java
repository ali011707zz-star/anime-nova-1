...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    public JsonValueObjectEncoderContext add(String str, int i10) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(i10);
    }

    public JsonValueObjectEncoderContext add(String str, long j10) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(j10);
    }

    public JsonValueObjectEncoderContext add(String str, boolean z10) throws IOException {
        maybeUnNest();
        this.jsonWriter.name(str);
        return add(z10);
    }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, int i10) throws IOException {
        return add(fieldDescriptor.getName(), i10);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, long j10) throws IOException {
        return add(fieldDescriptor.getName(), j10);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    public ObjectEncoderContext add(FieldDescriptor fieldDescriptor, boolean z10) throws IOException {
