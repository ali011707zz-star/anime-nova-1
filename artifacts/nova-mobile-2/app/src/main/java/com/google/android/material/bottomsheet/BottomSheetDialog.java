...
public class BottomSheetDialog extends b {
    ...
    public static class EdgeToEdgeCallback extends BottomSheetBehavior.BottomSheetCallback {
        ...
        private EdgeToEdgeCallback(View view, m0 m0Var) {
            ColorStateList u10;
            this.insetsCompat = m0Var;
            boolean z10 = Build.VERSION.SDK_INT >= 23 && (view.getSystemUiVisibility() & RecyclerView.e0.FLAG_BOUNCED_FROM_HIDDEN_LIST) != 0;
            ...
            if (materialShapeDrawable != null) {
                u10 = materialShapeDrawable.getFillColor();
            } else {
                u10 = b0.u(view);
            }
            if (u10 != null) {
                this.lightBottomSheet = MaterialColors.isColorLight(u10.getDefaultColor());
    ...
    private View wrapInBottomSheet(int i10, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        if (this.edgeToEdgeEnabled) {
            b0.G0(this.bottomSheet, new u() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.1
                @Override // q0.u
                public m0 onApplyWindowInsets(View view2, m0 m0Var) {
                    ...
                    if (m0Var != null) {
                        ...
                        bottomSheetDialog.edgeToEdgeCallback = new EdgeToEdgeCallback(bottomSheetDialog.bottomSheet, m0Var);
        ...
        b0.t0(this.bottomSheet, new a() { // from class: com.google.android.material.bottomsheet.BottomSheetDialog.3
            @Override // q0.a
