...
public final class zzbh extends zzaw {
    ...
    private static zzap zzc(zzbf zzbfVar, Iterator<zzap> it2, zzap zzapVar) {
        if (it2 != null) {
            while (it2.hasNext()) {
                zzap zzc = zzbfVar.zza(it2.next()).zzc((zzae) zzapVar);
                ...
                case 29:
                    ...
                    if (zzb instanceof zzae) {
                        ...
                        for (int i10 = 0; i10 < zzaeVar.zzc(); i10++) {
                            String zzi4 = zzaeVar.zze(i10).zzi();
                        ...
                        while (zzgVar.zzb(zzapVar).zzg().booleanValue()) {
                            ...
                            for (int i11 = 0; i11 < zzaeVar.zzc(); i11++) {
                                String zzi5 = zzaeVar.zze(i11).zzi();
