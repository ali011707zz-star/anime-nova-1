...
public class MaterialCardViewHelper {
    ...
    public MaterialCardViewHelper(MaterialCardView materialCardView, AttributeSet attributeSet, int i10, int i11) {
        ...
        if (obtainStyledAttributes.hasValue(i12)) {
            builder.setAllCornerSizes(obtainStyledAttributes.getDimension(i12, StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD));
        }
    ...
    private float calculateCornerPaddingForCornerTreatment(CornerTreatment cornerTreatment, float f10) {
        if (!(cornerTreatment instanceof RoundedCornerTreatment)) {
            return cornerTreatment instanceof CutCornerTreatment ? f10 / 2.0f : StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD;
        }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (this.clickableForegroundDrawable != null) {
            ...
            if (b0.E(this.materialCardView) == 1) {
                i13 = i16;
                i12 = i19;
            } else {
                i12 = i16;
