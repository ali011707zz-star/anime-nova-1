...
public final class zabl<O extends Api.ApiOptions> implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zat {
    ...
    public final void zaB() {
        ...
        zaJ();
        Iterator<zacc> it2 = this.zag.values().iterator();
        while (it2.hasNext()) {
            zacc next = it2.next();
    ...
    private final void zaH(Status status, Exception exc, boolean z10) {
        Handler handler;
        handler = this.zaa.zat;
    ...
    public final boolean zaL(boolean z10) {
        Handler handler;
        handler = this.zaa.zat;
        Preconditions.checkHandlerThread(handler);
    ...
    public static /* synthetic */ boolean zat(zabl zablVar, boolean z10) {
    ...
    public final void onConnectionSuspended(int i10) {
        ...
        if (myLooper == handler.getLooper()) {
            ...
            handler2 = this.zaa.zat;
            handler2.post(new zabi(this, i10));
        }
    }
    ...
    public final void zam() {
        ...
        try {
            ...
            try {
                ...
                zac(new ConnectionResult(10), e10);
            }
        } catch (IllegalStateException e11) {
            zac(new ConnectionResult(10), e11);
        }
    }
