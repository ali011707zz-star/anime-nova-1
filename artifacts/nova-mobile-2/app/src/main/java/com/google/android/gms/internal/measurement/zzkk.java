...
public final class zzkk {
    ...
    static {
        ...
        zzc = zzkkVar3;
        zzkk zzkkVar4 = new zzkk("FLOAT", 3, Float.TYPE, Float.class, Float.valueOf(StaticLayoutBuilderCompat.DEFAULT_LINE_SPACING_ADD));
        zzd = zzkkVar4;
        zzkk zzkkVar5 = new zzkk("DOUBLE", 4, Double.TYPE, Double.class, Double.valueOf(ShadowDrawableWrapper.COS_45));
        zze = zzkkVar5;
    ...
    private zzkk(String str, int i10, Class cls, Class cls2, Object obj) {
        this.zzl = cls;
        this.zzm = cls2;
        this.zzn = obj;
    }
