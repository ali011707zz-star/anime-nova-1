...
public final class AuthActivity extends a<z> {
    ...
    public void onCreate(Bundle bundle) {
        ...
        c().f8864c.setNavigationOnClickListener(new View.OnClickListener() { // from class: k5.a
        ...
        if (bundle == null) {
            ...
            if (l.a(extras3 == null ? null : extras3.getString("arg_request_type"), "LOGIN_WITH_EMAIL")) {
                l.e(m10.d(R.id.fragment_container_view, l5.a.class, getIntent().getExtras(), null), "add(containerViewId, F::class.java, args, tag)");
            } else {
                l.e(m10.d(R.id.fragment_container_view, m5.a.class, getIntent().getExtras(), null), "add(containerViewId, F::class.java, args, tag)");
            }
            m10.i();
        }
    }
