...
public interface ManagedClientConnection extends HttpClientConnection, HttpRoutedConnection, ConnectionReleaseTrigger {
    ...
    void tunnelProxy(HttpHost httpHost, boolean z10, HttpParams httpParams) throws IOException;

    void tunnelTarget(boolean z10, HttpParams httpParams) throws IOException;
