...
class Huffman {
    ...
    private void addCode(int i10, int i11, byte b10) {
        ...
        while (b10 > 8) {
            b10 = (byte) (b10 - 8);
            int i12 = (i11 >>> b10) & BaseProgressIndicator.MAX_ALPHA;
    ...
    public byte[] decode(byte[] bArr) {
        ...
        for (byte b10 : bArr) {
            ...
            i11 += 8;
            while (i11 >= 8) {
                node = node.children[(i10 >>> (i11 - 8)) & BaseProgressIndicator.MAX_ALPHA];
        ...
        while (i11 > 0) {
            Node node2 = node.children[(i10 << (8 - i11)) & BaseProgressIndicator.MAX_ALPHA];
    ...
    public void encode(i iVar, g gVar) throws IOException {
        long j10 = 0;
        int i10 = 0;
        for (int i11 = 0; i11 < iVar.y(); i11++) {
            int h10 = iVar.h(i11) & 255;
            int i12 = CODES[h10];
            byte b10 = CODE_LENGTHS[h10];
            j10 = (j10 << b10) | i12;
            i10 += b10;
            while (i10 >= 8) {
                i10 -= 8;
        ...
        if (i10 > 0) {
            gVar.O((int) ((BaseProgressIndicator.MAX_ALPHA >>> i10) | (j10 << (8 - i10))));
        }
    }
    ...
    public int encodedLength(i iVar) {
        ...
        for (int i10 = 0; i10 < iVar.y(); i10++) {
            j10 += CODE_LENGTHS[iVar.h(i10) & 255];
        }
        return (int) ((j10 + 7) >> 3);
    }
