...
public final class CipherSuite {
    ...
    public static final CipherSuite TLS_PSK_WITH_3DES_EDE_CBC_SHA = init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", TwitterApiConstants.Errors.ALREADY_FAVORITED);
    public static final CipherSuite TLS_PSK_WITH_AES_128_CBC_SHA = init("TLS_PSK_WITH_AES_128_CBC_SHA", TwitterAuthConfig.DEFAULT_AUTH_REQUEST_CODE);
    ...
    public static final CipherSuite TLS_EMPTY_RENEGOTIATION_INFO_SCSV = init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", BaseProgressIndicator.MAX_ALPHA);
