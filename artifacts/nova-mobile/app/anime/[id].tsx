...
const d = StyleSheet.create({
  ...
  watchBtn: { height: 44, borderRadius: 14, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#7C3AED" },
  epListBtn: { height: 44, borderRadius: 14, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, backgroundColor: "rgba(139,92,246,0.15)", borderWidth: 1.5, borderColor: "rgba(139,92,246,0.40)", paddingHorizontal: 14 },
  epListBtnText: { fontSize: 12, fontFamily: "Cairo_700Bold", color: "#c4b5fd" },
  watchBtnIcon: { width: 26, height: 26, backgroundColor: "rgba(255,255,255,0.2)", borderRadius: 9, alignItems: "center", justifyContent: "center" },
  watchBtnText: { fontSize: 13, fontFamily: "Cairo_800ExtraBold", color: "#fff" },
  ...
  warnText: { fontSize: 11, fontFamily: "Cairo_700Bold", color: "#fca5a5", padding: 10, lineHeight: 17 },
  warnBtn: { borderTopWidth: 1, borderTopColor: "rgba(239,68,68,0.2)", paddingVertical: 8, alignItems: "center", backgroundColor: "rgba(239,68,68,0.07)" },
  warnBtnText: { fontSize: 11, fontFamily: "Cairo_700Bold", color: "rgba(252,165,165,0.7)" },
  actionGrid: { flexDirection: "row", gap: 7, paddingHorizontal: 16, marginTop: 10 },
  actionBtn: { flex: 1, alignItems: "center", gap: 3, paddingVertical: 9, borderRadius: 14, backgroundColor: "rgba(255,255,255,0.04)", borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
