...
const g = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10, backgroundColor: "#18181B", borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
  ...
  searchWrap: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "#18181B", borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6, marginTop: 4, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
