...
const g = StyleSheet.create({
  ...
  tvChip: { paddingHorizontal: 16, paddingVertical: 9, borderRadius: 13, minHeight: 44, justifyContent: "center" },
  ...
  tvChipText: { fontSize: 16, lineHeight: 23 },
  ...
  tvSearchWrap: { minHeight: 52, borderRadius: 14, paddingHorizontal: 16, paddingVertical: 9, gap: 9 },
