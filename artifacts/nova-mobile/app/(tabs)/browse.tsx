...
const g = StyleSheet.create({
  ...
  searchWrap: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "#18181B", borderRadius: 12, paddingHorizontal: 10, paddingVertical: 5, marginTop: 6, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)" },
