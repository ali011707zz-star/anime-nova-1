...
const ep_s = StyleSheet.create({
  ...
  tvContainer: { paddingHorizontal: 40 },
  tvFocusGuide: { flex: 1 },
  tvControls: { paddingHorizontal: 40, paddingTop: 16, paddingBottom: 14 },
  tvHero: { height: 330 },
  tvBackBtn: { width: 54, height: 54, borderRadius: 16 },
  tvHeroBottom: { paddingHorizontal: 40, paddingBottom: 22, gap: 22 },
  tvHeroCover: { width: 140, height: 196, borderRadius: 18 },
  tvHeroInfo: { paddingBottom: 8 },
  tvHeroBadge: { fontSize: 17, lineHeight: 26 },
  tvHeroTitle: { fontSize: 32, lineHeight: 44 },
  tvText: { fontSize: 19, lineHeight: 29 },
  tvRow: { width: "23.5%", minHeight: 280, flexDirection: "column", alignItems: "stretch", paddingHorizontal: 16, paddingVertical: 16, gap: 14, borderRadius: 20, borderWidth: 1, borderBottomWidth: 1, borderColor: "rgba(255,255,255,0.08)", backgroundColor: "rgba(18,16,28,0.76)" },
  tvEpisodeMain: { width: "100%", flex: 0, flexDirection: "column", alignItems: "stretch", gap: 14, borderRadius: 16 },
  tvColumnWrapper: { justifyContent: "space-between", paddingHorizontal: 20, gap: 18 },
  tvListContent: { paddingTop: 8, gap: 20 },
  tvSmallButton: { width: 56, height: 56, borderRadius: 16 },
  tvSearchBar: { minHeight: 58, paddingVertical: 12, paddingHorizontal: 18, borderRadius: 14 },
  tvThumbWrap: { width: "100%", aspectRatio: 1.72, height: undefined, borderRadius: 14 },
  tvDurText: { fontSize: 9, paddingHorizontal: 5, paddingVertical: 2, borderRadius: 4 },
  tvInfo: { flex: 0, width: "100%", minHeight: 76 },
  tvEpisodeActions: { width: "100%", justifyContent: "flex-end", gap: 8 },
  tvEpNum: { fontSize: 21, lineHeight: 30 },
  tvEpTitle: { fontSize: 19, lineHeight: 29 },
  tvEpOriginal: { fontSize: 15, lineHeight: 23 },
  tvPageBtn: { width: 56, height: 56, borderRadius: 15 },
  tvWatchFromBtn: { marginHorizontal: 20, paddingVertical: 18, minHeight: 76, borderRadius: 20 },
  tvWatchFromBtnText: { fontSize: 19, lineHeight: 29 },
});
