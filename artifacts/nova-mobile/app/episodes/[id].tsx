...
const ep_s = StyleSheet.create({
  ...
  searchBar: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "#1C1C22", borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6, borderWidth: 1, borderColor: "rgba(255,255,255,0.06)", marginBottom: 5 },
  ...
  watchFromBtn: { flexDirection: "row", alignItems: "center", gap: 6, margin: 10, padding: 9, borderRadius: 12, borderWidth: 1, borderColor: "rgba(139,92,246,0.25)", backgroundColor: "rgba(139,92,246,0.07)" },
  watchFromBtnText: { fontSize: 11, fontFamily: "Cairo_700Bold", color: "#8B5CF6" },
  row: { flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 12, paddingVertical: 7, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.05)" },
