...
const SITE_TAG: Record<string, string> = {
  ...
  shirayuki_animepahe: "SY-AP", shirayuki_anikoto: "SY-AK",
  shirayuki_reanime: "SY-RA", shirayuki_animedao: "SY-AD",
  shirayuki_allanime: "SY-AA", shirayuki_animix: "SY-AX", shirayuki_senshi: "SY-SE",
  akwam: "AQ",
};
...
const SITE_LABEL: Record<string, string> = {
  ...
  shirayuki_animepahe: "Shirayuki · Pahe", shirayuki_anikoto: "Shirayuki · Anikoto",
  shirayuki_reanime: "Shirayuki · ReAnime", shirayuki_animedao: "Shirayuki · AnimeDao",
  shirayuki_allanime: "Shirayuki · AllAni", shirayuki_animix: "Shirayuki · AnimiX",
...
const SITE_DESC: Record<string, string> = {
  ...
  shirayuki_animepahe: "AniKuro · Pahe", shirayuki_anikoto: "AniKuro · Anikoto",
  shirayuki_reanime: "AniKuro · ReAnime", shirayuki_animedao: "AniKuro · AnimeDao",
  shirayuki_allanime: "AniKuro · AllAni", shirayuki_animix: "AniKuro · AnimiX",
  shirayuki_senshi: "AniKuro · Senshi",
...
const STATIC_PICKER: Record<QualityKey, { site: string; name: string; tag: string }[]> = {
  "1080p": [
    ...
    { site: "shirayuki_animepahe", name: "Shirayuki · Pahe",     tag: "SY-AP" },
    { site: "shirayuki_anikoto",   name: "Shirayuki · Anikoto",  tag: "SY-AK" },
    { site: "shirayuki_reanime",   name: "Shirayuki · ReAnime",  tag: "SY-RA" },
    { site: "shirayuki_animedao",  name: "Shirayuki · AnimeDao", tag: "SY-AD" },
    { site: "shirayuki_allanime",  name: "Shirayuki · AllAni",   tag: "SY-AA" },
    { site: "shirayuki_animix",    name: "Shirayuki · AnimiX",   tag: "SY-AX" },
    { site: "shirayuki_senshi",   name: "Shirayuki · Senshi",   tag: "SY-SE" },
  ],
  "720p": [
    { site: "animewitcher", name: "AnimeWitcher", tag: "AW" },
    { site: "sanime",       name: "سـAnime",      tag: "SA" },
...
const SITE_TIMEOUT_MAP: Record<string, number> = {
  anifox:       35_000,
  shirayuki_animepahe: 26_000, shirayuki_anikoto: 26_000,
  shirayuki_reanime: 26_000, shirayuki_animedao: 26_000,
  shirayuki_allanime: 26_000, shirayuki_animix: 26_000, shirayuki_senshi: 26_000,
  animewitcher: 38_000,
  animeify:     22_000,
  sanime:       18_000,
  kawaii:       15_000,
