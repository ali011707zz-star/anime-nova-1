...
const d = StyleSheet.create({
  ...
  tvHeader:     { paddingHorizontal: 40, paddingBottom: 14, gap: 12 },
  ...
  tvHeaderTitle: { fontSize: 23, lineHeight: 32 },
  tvHeaderSub: { fontSize: 15, lineHeight: 24 },
  ...
  tvHeaderActionBtn: { width: 48, height: 48, borderRadius: 14 },
  ...
  tvEpNavBtn:    { minWidth: 118, height: 52, borderRadius: 14, paddingHorizontal: 14, gap: 6 },
  epNavText:     { fontSize: 10, fontFamily: "Cairo_700Bold", color: "rgba(255,255,255,0.65)" },
  tvEpNavText:   { fontSize: 16, lineHeight: 24 },
  ...
  tvInfoTitle: { fontSize: 24, lineHeight: 36 },
  ...
  tvInfoEpBadge: { gap: 8, borderRadius: 12, paddingHorizontal: 16, paddingVertical: 10 },
  infoEpText:    { fontSize: 11, fontFamily: "Cairo_700Bold", color: "#c4b5fd" },
  tvInfoEpText: { fontSize: 18, lineHeight: 27 },
  ...
  tvScanExitBtn: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 13, gap: 7 },
  tvScanExitText: { fontSize: 15 },
  ...
  tvScrollContent: { paddingHorizontal: 40, paddingTop: 26, gap: 24 },
  ...
  tvQPill:       { paddingHorizontal: 24, paddingVertical: 13, borderRadius: 14 },
  tvQPillText:   { fontSize: 21, lineHeight: 31 },
  ...
  tvWebRow:       { minHeight: 116, paddingHorizontal: 24, paddingVertical: 22, gap: 20, borderRadius: 18 },
  tvWebRowTag:    { fontSize: 22, lineHeight: 32 },
  tvWebRowDot:    { width: 16, height: 16, borderRadius: 8 },
  tvSiteRowPlayBtn: { minWidth: 144, minHeight: 60, paddingHorizontal: 22, paddingVertical: 15, borderRadius: 15 },
  ...
  tvLockBtn:      { minWidth: 140, minHeight: 60, paddingHorizontal: 22, paddingVertical: 15, borderRadius: 15, gap: 8 },
  tvPickBtn:      { minWidth: 140, minHeight: 60, paddingHorizontal: 22, paddingVertical: 15, borderRadius: 15 },
  tvPlayBtn:      { minWidth: 164, minHeight: 60, paddingHorizontal: 22, paddingVertical: 15, borderRadius: 15, gap: 8 },
  tvActionText:   { fontSize: 20, lineHeight: 30 },
