...
const styles = StyleSheet.create({
  ...
  daysRow: { paddingHorizontal: 16, paddingVertical: 4, marginBottom: 12, alignItems: "center", flexDirection: "row" },
  dayBtn: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, borderWidth: 1, alignItems: "center", marginRight: 8 },
