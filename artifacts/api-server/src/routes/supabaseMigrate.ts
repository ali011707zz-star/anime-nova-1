...
const REQUIRED_TABLES = ["users", "pending_verifications", "watch_history", "favorites", "translations_cache", "anime_meta_ar", "anime_meta_cache", "anime", "site_cookies", "analytics_sessions", "analytics_episode_views"];
