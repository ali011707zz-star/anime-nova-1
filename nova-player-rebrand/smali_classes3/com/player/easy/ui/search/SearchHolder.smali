.class public final Lcom/player/easy/ui/search/SearchHolder;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lcom/player/easy/ui/search/SearchHolder;",
        ...
        "<init>",
        "(Landroid/view/View;Lcom/player/easy/ui/search/SearchAdapter;)V",
        "getAdapter",
        "()Lcom/player/easy/ui/search/SearchAdapter;",
        "binding",
...
.annotation build Lkotlin/jvm/internal/SourceDebugExtension;
    value = {
        "SMAP\nSearchHolder.kt\nKotlin\n*S Kotlin\n*F\n+ 1 SearchHolder.kt\ncom/player/easy/ui/search/SearchHolder\n+ 2 Contexts.kt\ncoil/Contexts\n*L\n1#1,47:1\n12#2:48\n*S KotlinDebug\n*F\n+ 1 SearchHolder.kt\ncom/player/easy/ui/search/SearchHolder\n*L\n43#1:48\n*E\n"
    }
.end annotation


# instance fields
.field private final adapter:Lcom/player/easy/ui/search/SearchAdapter;

.field private final binding:Lcom/player/easy/databinding/VideoListItemBinding;


# direct methods
.method public constructor <init>(Landroid/view/View;Lcom/player/easy/ui/search/SearchAdapter;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/player/easy/ui/search/SearchHolder;->adapter:Lcom/player/easy/ui/search/SearchAdapter;
    ...
    iput-object p1, p0, Lcom/player/easy/ui/search/SearchHolder;->binding:Lcom/player/easy/databinding/VideoListItemBinding;
...
.method public final bind(Lcom/player/easy/ui/videos/VideoStore;)V
    ...
    .line 21
    iget-object v0, p0, Lcom/player/easy/ui/search/SearchHolder;->binding:Lcom/player/easy/databinding/VideoListItemBinding;
    ...
    iget-object v4, p0, Lcom/player/easy/ui/search/SearchHolder;->binding:Lcom/player/easy/databinding/VideoListItemBinding;
    ...
    .line 26
    iget-object v2, p0, Lcom/player/easy/ui/search/SearchHolder;->adapter:Lcom/player/easy/ui/search/SearchAdapter;

    invoke-virtual {v2}, Lcom/player/easy/ui/search/SearchAdapter;->getFormatBuilder()Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v3, p0, Lcom/player/easy/ui/search/SearchHolder;->adapter:Lcom/player/easy/ui/search/SearchAdapter;

    invoke-virtual {v3}, Lcom/player/easy/ui/search/SearchAdapter;->getFormatter()Ljava/util/Formatter;
    ...
    iget-object v1, p0, Lcom/player/easy/ui/search/SearchHolder;->adapter:Lcom/player/easy/ui/search/SearchAdapter;

    invoke-virtual {v1}, Lcom/player/easy/ui/search/SearchAdapter;->getCurrentDate()Ljava/util/Date;
    ...
    .line 30
    :goto_0
    iget-object v1, p0, Lcom/player/easy/ui/search/SearchHolder;->binding:Lcom/player/easy/databinding/VideoListItemBinding;
    ...
    .line 33
    iget-object v0, p0, Lcom/player/easy/ui/search/SearchHolder;->adapter:Lcom/player/easy/ui/search/SearchAdapter;

    invoke-virtual {v0}, Lcom/player/easy/ui/search/SearchAdapter;->getCurrentYearDateFormat()Ljava/text/SimpleDateFormat;
    ...
    invoke-virtual {v0}, Lcom/player/easy/ui/search/SearchAdapter;->getYearDateFormat()Ljava/text/SimpleDateFormat;
    ...
    iget-object v2, p0, Lcom/player/easy/ui/search/SearchHolder;->binding:Lcom/player/easy/databinding/VideoListItemBinding;
...
.method public final getAdapter()Lcom/player/easy/ui/search/SearchAdapter;
    .locals 1
