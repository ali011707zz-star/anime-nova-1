...
.method public static final asCompletableFuture(Lkotlinx/coroutines/Deferred;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 71
    invoke-static {}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline5;->m()Ljava/util/concurrent/CompletableFuture;
    ...
    .line 73
    new-instance v1, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda6;

    invoke-direct {v1, v0, p0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda6;-><init>(Ljava/util/concurrent/CompletableFuture;Lkotlinx/coroutines/Deferred;)V
...
.method public static final asCompletableFuture(Lkotlinx/coroutines/Job;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 90
    new-instance v1, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda9;

    invoke-direct {v1, v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda9;-><init>(Ljava/util/concurrent/CompletableFuture;)V
...
.method private static final asCompletableFuture$lambda$1(Ljava/util/concurrent/CompletableFuture;Lkotlinx/coroutines/Deferred;Ljava/lang/Throwable;)Lkotlin/Unit;
    ...
    invoke-static {p0, p1}, Lkotlinx/coroutines/future/CompletableFutureCoroutine$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;Ljava/lang/Object;)Z
    :try_end_0
    ...
    .line 77
    invoke-static {p0, p1}, Lkotlinx/coroutines/future/CompletableFutureCoroutine$$ExternalSyntheticApiModelOutline1;->m(Ljava/util/concurrent/CompletableFuture;Ljava/lang/Throwable;)Z
...
.method public static final asDeferred(Ljava/util/concurrent/CompletionStage;)Lkotlinx/coroutines/Deferred;
    ...
    .line 115
    invoke-static {v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline1;->m(Ljava/util/concurrent/CompletableFuture;)Z
    ...
    .line 118
    :try_start_0
    invoke-static {v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline2;->m(Ljava/util/concurrent/CompletableFuture;)Ljava/lang/Object;
    ...
    .line 126
    new-instance v4, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda7;

    invoke-direct {v4, v1}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda7;-><init>(Lkotlinx/coroutines/CompletableDeferred;)V

    new-instance v5, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda8;

    invoke-direct {v5, v4}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda8;-><init>(Lkotlin/jvm/functions/Function2;)V

    invoke-static {p0, v5}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline3;->m(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletionStage;
...
.method private static final asDeferred$lambda$5(Lkotlinx/coroutines/CompletableDeferred;Ljava/lang/Object;Ljava/lang/Throwable;)Ljava/lang/Object;
    ...
    .line 134
    :cond_0
    invoke-static {p2}, Lkotlinx/coroutines/future/ContinuationHandler$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Z

    move-result p1

    if-eqz p1, :cond_1

    invoke-static {p2}, Lkotlinx/coroutines/future/ContinuationHandler$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/Object;)Ljava/util/concurrent/CompletionException;
    ...
    invoke-static {p1}, Lkotlinx/coroutines/future/ContinuationHandler$$ExternalSyntheticApiModelOutline2;->m(Ljava/util/concurrent/CompletionException;)Ljava/lang/Throwable;
...
.method public static final await(Ljava/util/concurrent/CompletionStage;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    .line 170
    invoke-static {p0, v2}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline3;->m(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletionStage;
...
.method public static final future(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 39
    invoke-static {p1, v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline4;->m(Ljava/util/concurrent/CompletableFuture;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
...
.method private static final setupCancellation(Lkotlinx/coroutines/Job;Ljava/util/concurrent/CompletableFuture;)V
    ...
    new-instance p0, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda10;

    invoke-direct {p0, v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda10;-><init>(Lkotlin/jvm/functions/Function2;)V

    invoke-static {p1, p0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline4;->m(Ljava/util/concurrent/CompletableFuture;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
