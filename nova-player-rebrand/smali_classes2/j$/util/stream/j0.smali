...
.method public static synthetic f(Ljava/util/stream/LongStream;)Lj$/util/stream/LongStream;
    .locals 1
...
.method public final synthetic A()Lj$/util/stream/IntStream;
    ...
    .line 0
    iget-object v1, p0, Lj$/util/stream/j0;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic a()Lj$/util/stream/LongStream;
    .locals 2
    ...
    invoke-static {v0}, Lj$/util/stream/j0;->f(Ljava/util/stream/LongStream;)Lj$/util/stream/LongStream;
...
.method public final synthetic asDoubleStream()Lj$/util/stream/DoubleStream;
    ...
    invoke-static {v0}, Lj$/util/stream/A;->f(Ljava/util/stream/DoubleStream;)Lj$/util/stream/DoubleStream;
...
.method public final synthetic average()Lj$/util/B;
    .locals 1
    ...
    invoke-static {v0}, Lj$/util/c;->j(Ljava/util/OptionalDouble;)Lj$/util/B;
...
.method public final synthetic b()Lj$/util/stream/LongStream;
    .locals 2
...
.method public final synthetic boxed()Lj$/util/stream/Stream;
    ...
    invoke-static {v0}, Lj$/util/stream/X2;->f(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic c()Lj$/util/stream/LongStream;
    .locals 2
...
.method public final d(Lj$/util/q;)Lj$/util/stream/LongStream;
    ...
    invoke-static {p1}, Lj$/util/stream/j0;->f(Ljava/util/stream/LongStream;)Lj$/util/stream/LongStream;
...
.method public final synthetic e()Lj$/util/stream/LongStream;
    .locals 2
...
.method public final synthetic findAny()Lj$/util/D;
    ...
    invoke-static {v0}, Lj$/util/c;->l(Ljava/util/OptionalLong;)Lj$/util/D;
...
.method public final synthetic iterator()Lj$/util/PrimitiveIterator$OfLong;
    ...
    iget-object v0, v0, Lj$/util/M;->a:Lj$/util/PrimitiveIterator$OfLong;
    ...
    invoke-direct {v1, v0}, Lj$/util/L;-><init>(Ljava/util/PrimitiveIterator$OfLong;)V
...
.method public final synthetic j()Lj$/util/stream/DoubleStream;
    .locals 2
...
.method public final synthetic mapToObj(Ljava/util/function/LongFunction;)Lj$/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/X2;->f(Ljava/util/stream/Stream;)Lj$/util/stream/Stream;
...
.method public final synthetic max()Lj$/util/D;
    .locals 1
...
.method public final synthetic min()Lj$/util/D;
    .locals 1
...
.method public final synthetic reduce(Ljava/util/function/LongBinaryOperator;)Lj$/util/D;
    .locals 1
    ...
    invoke-static {p1}, Lj$/util/c;->l(Ljava/util/OptionalLong;)Lj$/util/D;
...
.method public final synthetic spliterator()Lj$/util/Spliterator;
    ...
    invoke-static {v0}, Lj$/util/b0;->a(Ljava/util/Spliterator;)Lj$/util/Spliterator;
