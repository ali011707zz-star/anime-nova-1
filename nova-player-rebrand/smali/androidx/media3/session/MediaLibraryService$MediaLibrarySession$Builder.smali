...
.method public build()Landroidx/media3/session/MediaLibraryService$MediaLibrarySession;
    ...
    .line 692
    invoke-virtual {p0}, Landroidx/media3/session/MediaSession$BuilderBase;->ensureBitmapLoaderIsSizeLimited()V

    .line 693
    new-instance v0, Landroidx/media3/session/MediaLibraryService$MediaLibrarySession;

    iget-object v1, p0, Landroidx/media3/session/MediaSession$BuilderBase;->context:Landroid/content/Context;

    iget-object v2, p0, Landroidx/media3/session/MediaSession$BuilderBase;->id:Ljava/lang/String;

    iget-object v3, p0, Landroidx/media3/session/MediaSession$BuilderBase;->player:Landroidx/media3/common/Player;

    iget-object v4, p0, Landroidx/media3/session/MediaSession$BuilderBase;->sessionActivity:Landroid/app/PendingIntent;

    iget-object v5, p0, Landroidx/media3/session/MediaSession$BuilderBase;->customLayout:Lcom/google/common/collect/ImmutableList;

    iget-object v6, p0, Landroidx/media3/session/MediaSession$BuilderBase;->mediaButtonPreferences:Lcom/google/common/collect/ImmutableList;

    iget-object v7, p0, Landroidx/media3/session/MediaSession$BuilderBase;->commandButtonsForMediaItems:Lcom/google/common/collect/ImmutableList;

    iget-object v8, p0, Landroidx/media3/session/MediaSession$BuilderBase;->callback:Landroidx/media3/session/MediaSession$Callback;

    iget-object v9, p0, Landroidx/media3/session/MediaSession$BuilderBase;->tokenExtras:Landroid/os/Bundle;

    iget-object v10, p0, Landroidx/media3/session/MediaSession$BuilderBase;->sessionExtras:Landroid/os/Bundle;

    iget-object v11, p0, Landroidx/media3/session/MediaSession$BuilderBase;->bitmapLoader:Landroidx/media3/common/util/BitmapLoader;

    iget-boolean v12, p0, Landroidx/media3/session/MediaSession$BuilderBase;->playIfSuppressed:Z

    iget-boolean v13, p0, Landroidx/media3/session/MediaSession$BuilderBase;->isPeriodicPositionUpdateEnabled:Z
