...
.method private static convertContentUriTrigger(Landroidx/work/ContentUriTriggers$Trigger;)Landroid/app/job/JobInfo$TriggerContentUri;
    ...
    .line 140
    invoke-static {}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline7;->m()V

    invoke-virtual {p0}, Landroidx/work/ContentUriTriggers$Trigger;->getUri()Landroid/net/Uri;

    move-result-object p0

    invoke-static {p0, v0}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline6;->m(Landroid/net/Uri;I)Landroid/app/job/JobInfo$TriggerContentUri;
...
.method static setRequiredNetwork(Landroid/app/job/JobInfo$Builder;Landroidx/work/NetworkType;)V
    ...
    .line 158
    invoke-static {p0, p1}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline8;->m(Landroid/app/job/JobInfo$Builder;Landroid/net/NetworkRequest;)Landroid/app/job/JobInfo$Builder;
...
.method convert(Landroidx/work/impl/model/WorkSpec;I)Landroid/app/job/JobInfo;
    ...
    invoke-static {p2, v4}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline1;->m(Landroid/app/job/JobInfo$Builder;Landroid/app/job/JobInfo$TriggerContentUri;)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v4, v5}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline2;->m(Landroid/app/job/JobInfo$Builder;J)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v4, v5}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline3;->m(Landroid/app/job/JobInfo$Builder;J)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v1}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline4;->m(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
    ...
    invoke-static {p2, v0}, Landroidx/media3/exoplayer/scheduler/PlatformScheduler$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
    ...
    .line 130
    invoke-static {p2, v3}, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter$$ExternalSyntheticApiModelOutline5;->m(Landroid/app/job/JobInfo$Builder;Z)Landroid/app/job/JobInfo$Builder;
